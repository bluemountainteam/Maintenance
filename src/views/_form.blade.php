<div class="panel panel-danger">
    <div class="panel-body">
        <div class="form-group form-checkbox">
            <div class="col-sm-9">
                @if(!$maintenance->id)
                    {!! Form::checkbox('status',1,null,['class' => 'form-control activer','id' => 'maintenance_activ']) !!}
                @else
                    {!! Form::checkbox('status',1,null,['class' => 'form-control ','id' => 'maintenance_activ']) !!}

                @endif
                <label for="maintenance_activ"
